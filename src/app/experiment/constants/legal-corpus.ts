...
Pending before the court is an issue that has become central to the ongoing discussions of the relationship between law and technology: the use of artificial intelligence ("AI") in the drafting of legal documents. On December 18, 2025, the court issued an order to show cause as to why Appellant's counsel should not be sanctioned for including, in a brief, quotations, citations, and assertions that were not supported by the underlying case law.
